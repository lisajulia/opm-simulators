...
def are_similar(obj1, obj2, verbose, precision=0.999, atol=5e-9): # todo: is 0.99 and 5e-8 ok??
    """
...
def compare_across_files(file1_path, file2_path, file3_path, verbose):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Compare the duneBGlobal_, duneCGlobal_, duneD_ matrices and residual in three files.")
    ...
    compare_across_files(args.file1, args.file2, args.file3, args.verbose)
