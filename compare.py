...
def compare_across_files(file1_path, file2_path, verbose):
    ...
    for matrix_name in matrix_names :
        ...
        if are_similar(matrix1, matrix2, verbose):
            ...
            print(f"{matrix_name}: Matrices for {file1_path} and {file2_path} are different.")
        
    vector_names = ['duneResidual']
    for vector_name in vector_names:
        print(f"\nWill check vector {vector_name}...")
        ...
        if are_similar(matrix1, matrix2, verbose):
            ...
            print(f"{vector_name}: Vectors for {file1_path} and {file2_path} are different.")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Compare the duneBGlobal_, duneCGlobal_ and duneD_ matrices in two or three files.")
    parser.add_argument("verbosity", help="Verbosity flag")
    parser.add_argument("file1", help="Path to the first file")
    parser.add_argument("file2", help="Path to the second file")
    parser.add_argument("file3", nargs='?', default=None, help="Path to the third file (optional)")

    args = parser.parse_args()
    print(args)
    print(f"======================================================== COMPARE FILES {args.file1} AND {args.file2} ========================================================")

    compare_across_files(args.file1, args.file2, str_to_bool(args.verbosity))
    if (args.file3):
        print(f"\n\n======================================================== COMPARE FILES {args.file1} AND {args.file3} ========================================================")
        compare_across_files(args.file1, args.file3, str_to_bool(args.verbosity))
        print(f"\n\n======================================================== COMPARE FILES {args.file2} AND {args.file3} ========================================================")
        compare_across_files(args.file2, args.file3, str_to_bool(args.verbosity))
